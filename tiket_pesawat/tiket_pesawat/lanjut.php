...
<head>
    ...
    background-image: url('https://media.istockphoto.com/id/155439315/id/foto/pesawat-penumpang-terbang-di-atas-awan-saat-matahari-terbenam.jpg?s=612x612&w=0&k=20&c=1coS8GO8AYIZUci-h7251JFy3JaNj2ZuKWexlGT04v8=');
...
<div class="container">
    ...
    <form action="pembayaran.php" method="POST">
        ...
        <div class="form-section">
            ...
            <input type="telepon" name="no_hp" required>
        </div>
            <button type="submit" class="lanjut-btn">Lanjut ke Pembayaran</button>
        </div>
    </form>
</div>
</body>
